...
function toggle(e,t){var n=document.getElementById(e);"none"!=n.style.display?(n.style.display="none",document.getElementById(t).setAttribute("aria-expanded","false")):(n.style.display="",document.getElementById(t).setAttribute("aria-expanded","true"))}
function autocomplet() {
	var min_length = 2;
	var keyword = $('#recherche_field').val();
