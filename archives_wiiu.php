...
<?php
$retour = $db->query('SELECT * FROM news LEFT JOIN forum_membres ON membre_id = posteur_id WHERE valide = 1 AND icon = 2 ORDER BY id DESC') or die(print_r($db->errorInfo()));
$JourSemaine = null;
$Mois = null;
...
echo'<br>'; ?>
<div class="news-wii-u">Wii U</div>
