...
echo'<div class="barreonglets"><a class="onglet" href="sij">PD1</a> <a class="onglet" href="sij">PD2</a></div> ';
...
echo '<h1>Modifier son mot de passe</h1><br>
...
echo '<h1>Modifier son profil</h1>';
    ...
    $annee = $date['year'];
        ...
        if ($data['article1']==1) {
        echo'<label for="article1">Couleur du pseudo :</label><textarea type="text" name="article1" id="article1">'.stripslashes($data['membre_couleur']).'</textarea>';
        } else {
        echo'<p align=center>Vous n\'avez encore acheté aucun article à la boutique. <a href="/boutique.html">Pourquoi ne pas aller y faire un tour ?</a></p>';
        }
        echo'<br><br>
        </fieldset>
...
if ($handle)
{
    ...
    if ($i == 0) // Si $i est vide, il n'y a pas d'erreur
    {
        ...
        birthday=:birthday WHERE membre_id=:id');
        $query->bindValue(':mail',$email,PDO::PARAM_STR);
        ...
        $colorReq->bindValue(':couleur',$couleur,PDO::PARAM_STR);
