...
<h3 style="background-color:#19af5d;"><i class="material-icons materialIndex">info_outline</i> Statistiques</h3><br>';
...
<div class="beforeFooter">
  <a href="https://www.facebook.com/planete.toad/" title="Page Facebook du site" target="_blank" class="rsocial facebook"></a>
  <a href="https://twitter.com/planetetoad" title="Page Twitter du site" target="_blank" class="rsocial twitter"></a>
  <a href="https://www.youtube.com/channel/UCRql8l00_wv2t1p9tqOnCiw" target="_blank" title="Chaine Youtube du site" class="rsocial youtube"></a>
  <a href="https://www.dubtrack.fm/join/club-de-planete-toad" title="Salle Dubtrack.fm du site" target="_blank" class="rsocial dubtrack"></a>
</div>
...
<a href="https://mkpc.malahieude.net" rel="nofollow" title="Mario Kart PC" target="_blank"><img src="../images/partenaires/mkpc.png" alt="Mario Kart PC Site Partenaire" title="Mario Kart PC site partenaire" width="88" height="31" /></a><br>
<a href="http://www.vanilladome.fr/" rel="nofollow" title="Vanilla Dome" target="_blank"><img src="../images/partenaires/vdpartenaire.png" alt="Vanilla Dome" title="Vanilla Dome" width="88" height="31" /></a>
    ...
    <div class="mdl-mega-footer__drop-down-section">
      <div class="mdl-mega-footer__link-list">
      <div class="footerText">
    <h4 class="mdl-mega-footer__heading">LIENS</h4>
    </div>
<br>
<?php 
// Admin
if ($lvl>4) {
echo'<a href="/admin/index.php" style="color:white;"><i class="material-icons md-12">send</i> Administration</a><br><br>';
}
// Modos
if ($lvl>3) {
echo'<a href="/modo/index.php" style="color:white;"><i class="material-icons md-12">send</i> Modération</a><br><br>';
}
//Rédacteurs
if ($lvl>=3) {
...
echo'<a href="/liste_news.php" style="color:white;"><i class="material-icons md-12">send</i> Rédaction ';
if ($newsValidate!="0") { echo'<span style="color:cyan;">('.$newsValidate.' à valider)</span></a><br><br>'; } else {
echo'('.$newsValidate.' à valider)</a><br><br>'; } // NEWS A VALIDER
} 
//Qui est en ligne détaillé
if ($lvl>3) {
echo'<a href="/quiestenligne.php" style="color:white;"><i class="material-icons md-12">send</i> Qui est en ligne détaillé</a><br>';
}
?>
<p><a href="./equipe.html" style="color:white;font-weight:normal;" title="Equipe du site"><i class="material-icons md-12">send</i> Equipe</a><br><br>
<a href="./topic-1-1.html" style="color:white;font-weight:normal;" title="Charte du site"><i class="material-icons md-12">send</i> Charte</a><br><br> 
<a href="./contact.html" style="color:white;font-weight:normal;" title="Contacter le site"><i class="material-icons md-12">send</i> Contact</a><br><br> 
<a href="./apropos.html" style="color:white;font-weight:normal;" title="A propos de P.T"><i class="material-icons md-12">send</i> A propos</a><br><br> 
<a href="./devenir-partenaire.html" style="color:white;font-weight:normal;" title="Devenir partenaire"><i class="material-icons md-12">send</i> Devenir partenaire</a><br></p><br>
      </div>
    </div>
  </div>
...
<div class="afterFooter">
  &copy; Planète Toad 2014-<?php echo date('Y') ?>
</div>
<?php
