...
if ((isset($_COOKIE['design']) && $_COOKIE['design']==5)) {
	echo'<link rel="stylesheet" type="text/css" href="slider/styleNoir.css" />';
}?><div id="wowslider-container1">
<div class="ws_images"><ul>
        <li><a href="https://hillsong.com/la/"><img src="//images.planete-toad.fr/sliders/anniv-pt.jpg" alt="Bientôt l'anniversaire de PT !" title="Bientôt l'anniversaire de PT !" id="wows1_0"/></a></li>
		<li><a href="/news-2724--wrestlemarioune-nouvelle-animation-va-voir-le-jour.html"><img src="//images.planete-toad.fr/sliders/WrestleMario.jpg" alt="Découvrez Wrestle Mario, la nouvelle animation de Planète Toad." title="Découvrez Wrestle Mario, la nouvelle animation de Planète Toad." id="wows1_1"/></a></li>
        <li><a href="/chronique-2721-planete-actuc-est-l-ete.html"><img src="//images.planete-toad.fr/sliders/planete-actu-4.jpg" alt="La 6ème édition de Planète Actu est disponible !" title="La 6ème édition de Planète Actu est disponible !" id="wows1_2"/></a></li>
	</ul></div>
	<div class="ws_bullets"><div>
    <a href="#" title="Redécouvrez l'église comme vous ne l'avez jamais connue !"><span>1</span></a>
    <a href="#" title="Découvrez Wrestle Mario, la nouvelle animation de Planète Toad !"><span>2</span></a>
    <a href="#" title="La 6ème édition de Planète Actu est disponible !"><span>3</span></a>
	</div></div>
...
while ($donnees = $retour->fetch())
{
	...
	<div class="affichNews">
        ...
        echo'<img src="//images.planete-toad.fr/LOGOPT3100.png" style="margin-left:auto;margin-right:auto;box-shadow:2px 1px 10px grey;" width="100" height="100" title="'.$donnees['titre'].'" alt="'.$donnees['titre'].'" />';
			 } ?>
