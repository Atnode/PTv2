...
if (isset($_POST['commenter'])) 
{
    ...
    $oldNews = $db->prepare('SELECT * FROM news WHERE id = '.$_GET['news'].'');
    $oldNews->execute();
    ...
    if ($OneMonth<2629800) {    
	  ...
	  $AddCom = $db->prepare('INSERT INTO commentaires (id_posteur,id_news,commentaire,timestamp) VALUES(:posteur_id, :news, :commentaire, :timestamp)');
