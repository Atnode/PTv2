...
<h1>Archive des news du site</h1>
<div class="archivesnews">
<?php
$retour = $db->query('SELECT * FROM news LEFT JOIN forum_membres ON membre_id = posteur_id WHERE valide = 1 AND icon = 0 ORDER BY id DESC') or die(print_r($db->errorInfo()));
$JourSemaine = null;
$Mois = null;
